    ...
    thief = {
        ...
        promotions = {
            rogue = {
                name = "Rogue",
                stat_bonuses = {
                    maxHp = 2, maxWisp = 1, attackStat = 4, defenseStat = 3,
            ...
            assassin = {
                name = "Assassin",
                stat_bonuses = {
                    maxHp = 1, maxWisp = 1, attackStat = 5, defenseStat = 1,
    ...
    warrior = {
        ...
        promotions = {
            executioner = {
                name = "Executioner",
                stat_bonuses = {
                    maxHp = 3, maxWisp = 0, attackStat = 5, defenseStat = 2,
            ...
            sentinel = {
                name = "Sentinel",
                stat_bonuses = {
                    maxHp = 5, maxWisp = 0, attackStat = 2, defenseStat = 5,
    ...
    scout = {
        ...
        promotions = {
            ranger = {
                name = "Ranger",
                stat_bonuses = {
                    maxHp = 2, maxWisp = 1, attackStat = 3, defenseStat = 2,
            ...
            sniper = {
                name = "Sniper",
                stat_bonuses = {
                    maxHp = 1, maxWisp = 1, attackStat = 4, defenseStat = 1,
    ...
    mage = {
        ...
        promotions = {
            wizard = {
                name = "Wizard",
                stat_bonuses = {
                    maxHp = 1, maxWisp = 2, attackStat = 0, defenseStat = 1,
            ...
            luminary = {
                name = "Luminary",
                stat_bonuses = {
                    maxHp = 2, maxWisp = 2, attackStat = 0, defenseStat = 2,
    ...
    knight = {
        ...
        promotions = {
            paladin = {
                name = "Paladin",
                stat_bonuses = {
                    maxHp = 4, maxWisp = 1, attackStat = 2, defenseStat = 4,
            ...
            cavalier = {
                name = "Cavalier",
                stat_bonuses = {
                    maxHp = 3, maxWisp = 0, attackStat = 4, defenseStat = 3,
    ...
    druid = {
        ...
        promotions = {
            warlock = {
                name = "Warlock",
                stat_bonuses = {
                    maxHp = 2, maxWisp = 1, attackStat = 0, defenseStat = 2,
            ...
            necromancer = {
                name = "Necromancer",
                stat_bonuses = {
                    maxHp = 3, maxWisp = 1, attackStat = 1, defenseStat = 3,
    ...
    bard = {
        ...
        promotions = {
            soothsayer = {
                name = "Soothsayer",
                stat_bonuses = {
                    maxHp = 2, maxWisp = 3, attackStat = 0, defenseStat = 1,
            ...
            troubadour = {
                name = "Troubadour",
                stat_bonuses = {
                    maxHp = 2, maxWisp = 2, attackStat = 1, defenseStat = 2,
    ...
    lancer = {
        ...
        promotions = {
            dragonlord = {
                name = "Dragonlord",
                stat_bonuses = {
                    maxHp = 4, maxWisp = 0, attackStat = 4, defenseStat = 4,
            ...
            stormrider = {
                name = "Stormrider",
                stat_bonuses = {
                    maxHp = 3, maxWisp = 1, attackStat = 4, defenseStat = 2,
            ...
            dragoon = {
                name = "Dragoon",
                stat_bonuses = {
                    maxHp = 3, maxWisp = 0, attackStat = 5, defenseStat = 3,
